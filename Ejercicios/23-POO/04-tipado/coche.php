...
class Coche{
    ...
    public function mostrarInfo(Coche $miObjeto){ //aqui le especificamos que el objeto recibido tiene que ser de tipo coche, osea que la clase desde el
    // cual se creo sea la clase Coche
        $informacion = "<h1>Información del coche</h1></br>";
